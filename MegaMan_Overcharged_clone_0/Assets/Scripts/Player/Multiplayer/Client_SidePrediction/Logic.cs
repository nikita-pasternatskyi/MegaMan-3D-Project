    ...
    private void Update()
    {
        ...
        if (isClient)
        {
            ...
            while (client_timer >= dt)
            {
                ...
                Inputs inputs;
                inputs.up = Keyboard.current.wKey.isPressed;
                inputs.down = Keyboard.current.sKey.isPressed;
                inputs.left = Keyboard.current.aKey.isPressed;
                inputs.right = Keyboard.current.dKey.isPressed;
